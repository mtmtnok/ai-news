...
window.RELATIONS = {
  ...
  edges: [
    ...
    { from: "openai", to: "amazon", type: "partner", threads: ["compute"], flow: "計算資源",
    ...
    { from: "nvidia", to: "microsoft", type: "partner", threads: ["compute"], flow: "計算資源",
      label: "AzureへGrace Blackwell GB200、DGX Cloud／Microsoft Fabric連携、NVIDIA AIマイクロサービスを展開する生成AI基盤提携", date: "2024-03",
    ...
    { from: "nvidia", to: "google", type: "partner", threads: ["compute"], flow: "計算資源",
      label: "Google CloudがGrace BlackwellとDGX Cloudを採用。Vertex AI、NIM、JAXなどでAI基盤・ソフトウェアを統合", date: "2024-03",
    ...
    { from: "nvidia", to: "amazon", type: "partner", threads: ["compute"], flow: "計算資源",
      label: "AWSでBlackwell GPU、DGX Cloud、SageMakerとNIMを展開。NVIDIAの研究用AIスーパーコンピュータProject CeibaもAWS上で共同構築", date: "2024-03",
    ...
    { from: "nvidia", to: "oracle", type: "partner", threads: ["compute"], flow: "計算資源",
      label: "OCI上でNVIDIA AI EnterpriseとNIMをネイティブ提供。AI推論、AI Blueprints、Oracle Database 23aiのベクトル検索を統合", date: "2025-03",
    ...
    { from: "nvidia", to: "nebius", type: "partner", threads: ["compute"], flow: "計算資源",
      label: "フルスタックAIクラウドを共同開発。NVIDIAは20億ドルを投資し、Nebiusは2030年末までにNVIDIAシステム5GW超の展開を目指す", date: "2026-03",
    ...
    { from: "nvidia", to: "noetra", type: "partner", threads: ["japan", "compute"], flow: "計算資源",
      label: "次世代GPU「Rubin」約2.75万基・CPU「Vera」約1.375万基を独占供給（2028年6月稼働目標・大阪堺市）", date: "2026-07",
      source: "https://response.jp/article/2026/07/17/414143.html" },
